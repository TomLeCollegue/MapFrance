...
object XmlParser {
    ...
    fun getAttributeStrokeLineCap(
        ...
        return getAttributeValue(xpp, attributeName)?.let { getStrokeLineCap(it.toInt(), defValue) }
            ?: defValue
    }
    ...
    fun getAttributePathFillType(
        ...
        return getAttributeValue(xpp, attributeName)?.let { getPathFillType(it.toInt(), defValue) }
            ?: defValue
    }
